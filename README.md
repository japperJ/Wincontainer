...
- [Set up WinContainers on a VM](https://youtu.be/r2td0mPynyw)
- [Update WinContainers](https://youtu.be/H5HmRPLBMhA)
- [MCP server demo](https://youtu.be/YuFkDVEwS4M)
- [AI in WinContainers](https://youtu.be/XMDfWeGzbmk)
